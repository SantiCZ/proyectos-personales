...
using namespace std;
// Estructura para almacenar la informacion de una persona
struct Persona {
    string nombre;
    string telefono;
};
// Funcion para guardar datos de personas en un archivo
void guardarPersonas(const string& nombreArchivo) {
    const int numPersonas = 5;  // Numero de personas a registrar
